      ...
      <div class="hero-inner">
        <div class="hero-text">
          ...
          <p class="hero-description">
            ...
            ChatGPT・Claude・Copilotなど多数のAIツールに対応。<br>
            企画・実施・定着まで、すべて伴走します。
          </p>
          <div class="btn-group">
    ...
    <div class="container">
      ...
      <div class="features-grid">
        <div class="feature-card reveal">
          ...
          <h3>あまたのAIツールを使い倒した「実践者」が教える</h3>
          <p>ChatGPT・Claude・Copilot・Notion AI・Dify・Zapierなど、数多くのAIツールを自社業務で徹底的に使い込んできた実体験があるから教えられる。机上の空論ではない、リアルな活用法をお届けします。</p>
          <span class="feature-card-tag">多数のAIツール知見</span>
        </div>
        <div class="feature-card reveal">
          ...
          <p>「初心者でも分かる」を徹底。専門用語を噛み砕き、全員が「自分でもできそう」と思える研修を設計します。Copilotなど開発者向けAIツールの研修にも対応。</p>
          <span class="feature-card-tag">Copilot研修にも対応</span>
        </div>
        <div class="feature-card reveal">
